...
p api.new.query.titles('Argentina').prop(:revisions).prop(:timestamp).prop(:info).prop(:url).to_h
#response = api.new.query.titles('Argentina').prop(:revisions).prop(:timestamp).prop(:info).prop(:url).response
#pp response.to_h
