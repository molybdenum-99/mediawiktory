...
#
class MediaWiktory::Wikipedia::Feedwatchlist < GetAction
  ...
  # @return [self]
  def linktosections(value = true)
    merge(linktosections: 'true') if value
  end
  # Include multiple revisions of the same page within given timeframe.
  #
  # @param value [true, false]
  # @return [self]
  def allrev(value = true)
    merge(allrev: 'true') if value
  end
