...
module MediaWiktory::Wikipedia
  module Actions
    ...
    #
    # ```ruby
    # api.watch(**options).perform # returns string with raw output
    # # or
    # api.watch(**options).response # returns output parsed and wrapped into Mash-like object
    #
    # # or, with chainable interface:
    # api.watch.title(value).perform
    # ```
    #
