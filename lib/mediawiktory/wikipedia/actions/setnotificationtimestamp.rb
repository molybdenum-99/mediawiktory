...
module MediaWiktory::Wikipedia
  module Actions
    ...
    #
    # ```ruby
    # api.setnotificationtimestamp(**options).perform # returns string with raw output
    # # or
    # api.setnotificationtimestamp(**options).response # returns output parsed and wrapped into Mash-like object
    #
    # # or, with chainable interface:
    # api.setnotificationtimestamp.entirewatchlist(value).perform
    # ```
    #
