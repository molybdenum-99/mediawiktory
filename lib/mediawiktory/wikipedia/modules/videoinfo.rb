  ...
  module Modules
    ...
    module Videoinfo
      ...
      def prop_single(value)
        defined?(super) && super || ["timestamp", "user", "userid", "comment", "parsedcomment", "canonicaltitle", "url", "size", "dimensions", "sha1", "mime", "thumbmime", "mediatype", "metadata", "commonmetadata", "extmetadata", "archivename", "bitdepth", "uploadwarning", "badfile", "derivatives", "timedtext"].include?(value.to_s) && merge(viprop: value.to_s)
      end
      ...
      # @private
      def extmetadatafilter_single(value)
        merge(viextmetadatafilter: value.to_s)
      end
