...
module MediaWiktory::Wikipedia
  module Modules
    ...
    #
    # ```ruby
    # api.some_action.contenttranslationsuggestions(**options).perform # returns string with raw output
    # # or
    # api.some_action.contenttranslationsuggestions(**options).response # returns output parsed and wrapped into Mash-like object
    #
    # # or, with chainable interface:
    # api.some_action.contenttranslationsuggestions.from(value).perform
    # ```
    #
