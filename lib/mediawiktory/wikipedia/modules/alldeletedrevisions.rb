module MediaWiktory::Wikipedia::Modules
  ...
  # api.some_action.alldeletedrevisions.prop(value).perform
  # ```
  #
  ...
  #
  class Alldeletedrevisions < MediaWiktory::Submodule
    ...
    def contentformat(value)
      merge(adrcontentformat: value.to_s)
    end
    ...
    def namespace(*values)
      merge(adrnamespace: values.join('|'))
    end
