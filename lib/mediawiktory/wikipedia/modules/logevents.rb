module MediaWiktory::Wikipedia::Modules
  ...
  #
  # ```ruby
  # api.some_action.logevents(**options).perform # returns string with raw output
  # # or
  # api.some_action.logevents(**options).response # returns output parsed and wrapped into Mash-like object
  #
  # # or, with chainable interface:
  # api.some_action.logevents.prop(value).perform
  # ```
  #
  ...
  #
  class Logevents < MediaWiktory::Submodule
