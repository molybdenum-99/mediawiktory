...
module MediaWiktory::Wikipedia
  module Modules
    ...
    module Allpages
      ...
      # @private
      def _prtype(value)
        defined?(super) && super || ["edit", "move", "upload"].include?(value.to_s) && merge(apprtype: value.to_s, replace: false)
      end
      ...
      # @private
      def _prlevel(value)
        defined?(super) && super || ["autoconfirmed", "extendedconfirmed", "templateeditor", "sysop"].include?(value.to_s) && merge(apprlevel: value.to_s, replace: false)
      end
