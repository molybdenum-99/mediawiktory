...
#
class MediaWiktory::Wikipedia::Feedcontributions < GetAction
  ...
  # @return [self]
  def deletedonly(value = true)
    merge(deletedonly: 'true') if value
  end
  # Only show edits that are the latest revisions.
  #
  # @param value [true, false]
  # @return [self]
  def toponly(value = true)
    merge(toponly: 'true') if value
  end
  # Only show edits that are page creations.
  #
  # @param value [true, false]
  # @return [self]
  def newonly(value = true)
    merge(newonly: 'true') if value
  end
  # Hide minor edits.
  #
  # @param value [true, false]
  ...
  # @param value [true, false]
  # @return [self]
  def showsizediff(value = true)
    merge(showsizediff: 'true') if value
  end
