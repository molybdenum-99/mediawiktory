...
module MediaWiktory::Wikipedia
  ...
  class Response
    ...
    # @private
    METADATA_KEYS = %w[error warnings batchcomplete continue success]
    ...
    # tends to return the same object's data continued on the next request page.)
    #
    # @return [Response]
    def continue
    ...
    def error!
      fail Error, @metadata.dig('error', 'info')
    end
  end
end
