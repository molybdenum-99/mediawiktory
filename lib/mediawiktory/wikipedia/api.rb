...
#
# _Generated from https://en.wikipedia.org/w/api.php at May 07, 2017 by MediaWiktory 0.1.0._
#
# It also can be used for access to any other MediaWiki site, but some of actions could be
# non-existent/outdated.
#
# See {MediaWiktory::Wikipedia::Api} for usage.
#
module MediaWiktory::Wikipedia
  # Base API class for [Wikipedia](https://en.wikipedia.org/wiki/Main_Page).
  #
  # Example of usage:
  #
  # ```ruby
