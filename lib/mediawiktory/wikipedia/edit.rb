...
#
class MediaWiktory::Wikipedia::Edit < GetAction
  ...
  # @return [self]
  def minor(value = true)
    merge(minor: 'true') if value
  end
  # Non-minor edit.
  #
  # @param value [true, false]
  # @return [self]
  def notminor(value = true)
    merge(notminor: 'true') if value
  end
  ...
  # @param value [true, false]
  # @return [self]
  def recreate(value = true)
    merge(recreate: 'true') if value
  end
  # Don't edit the page if it exists already.
  #
  # @param value [true, false]
  # @return [self]
  def createonly(value = true)
    merge(createonly: 'true') if value
  end
...
Use section=new to append a new section, rather than this parameter.
  ...
  # @param value [true, false]
  # @return [self]
  def redirect(value = true)
    merge(redirect: 'true') if value
  end
