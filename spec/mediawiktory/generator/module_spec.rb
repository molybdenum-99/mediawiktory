...
RSpec.describe MediaWiktory::Generator::Module do
  describe '.from_nodes' do
    subject(:mod) { described_class.from_html_nodes(name, nodes) }
    ...
    context 'abusefiltercheckmatch (simple)' do
      ...
      its(:name) { is_expected.to eq 'abusefiltercheckmatch' }
  ...
  describe '#to_html' do
    ...
    it 'renders generic docs' do
      is_expected
        ...
        .and include('api.abusefiltercheckmatch.filter(value).perform')
    end
